...
<body>
	<div class="container">
		...
		<form id="frmEmpLivro" name="frmEmpLivro" method="POST" action="empLivro.php">
			...
			<?php } ?>
			<div class="form-group col-md-8">
				<label for="lblDataE">Data Emprestimo: </label>
				<input type="date" class="form-control col-md-5" id="txtDataE" name="txtDataE" required>
			</div>
			<hr>
			<input type="submit" id="btEnviar" name="btEnviar" class="btn btn-success" value="EMPRESTAR">
